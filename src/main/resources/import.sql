...
INSERT INTO tb_product (names, price, category, ramo, img_url, short_description, long_description) VALUES ('Tabuleiro Gu', 400.8, 'Tabul', 'Party inf','https://raw.githubusercontent.com/thaleslsmelo/listparty/refs/heads/main/src/main/resources/imagens/Fini.png', 'Curta Descriçao:', 'Longa Descrição');
INSERT INTO tb_product (names, price, category, ramo, img_url, short_description, long_description) VALUES ('Tabuleiro Açai', 470,'Tabul', 'Party inf','https://raw.githubusercontent.com/thaleslsmelo/listparty/refs/heads/main/src/main/resources/imagens/Fini.png', 'Curta Descriçao:', 'Longa Descrição');
...
INSERT INTO tb_product (names, price, category, ramo, img_url, short_description, long_description) VALUES ('Tabuleiro', 350, 'Tabul', 'Party inf', 'https://raw.githubusercontent.com/devsuperior/java-spring-dslist/main/resources/4.png', 'Curta Descriçao:', 'Longa Descrição');
INSERT INTO tb_product (names, price, category, ramo, img_url, short_description, long_description) VALUES ('Tabuleiro', 460, 'Tabul', 'Festas 15Anos','https://raw.githubusercontent.com/devsuperior/java-spring-dslist/main/resources/5.png', 'Curta Descriçao:', 'Longa Descrição');
...
INSERT INTO tb_product (names, price, category, ramo, img_url, short_description, long_description) VALUES ('Baloeiro', 480, 'Recp', 'Party inf','https://raw.githubusercontent.com/devsuperior/java-spring-dslist/main/resources/8.png', 'Personagem com Balões de gás Hélio', 'Longa Descrição');
